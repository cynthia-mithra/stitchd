    ...
    <>
      ...
      <div style={{...S.searchBar,position:"relative"}} id="grid-anchor">
        ...
        {(showSuggestions&&searchSuggestions.length>0)||(showSavedSearches&&savedSearches.length>0)?(
          <div style={{position:"absolute",top:"100%",left:"50%",transform:"translateX(-50%)",width:"100%",maxWidth:460,background:"#fff",border:"2px solid #111",borderTop:"none",zIndex:200,maxHeight:280,overflowY:"auto"}}>
