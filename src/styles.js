...
export const S={
  ...
  // FILTERS / TAILORS buttons on wide screens). A slimmer 34px height + tighter
  ...
  searchInner:{display:"flex",alignItems:"stretch",height:34,width:"100%",maxWidth:680,margin:"0 auto",padding:"0 10px"},
  ...
  filterBtn:{background:"#fff",border:"none",borderLeft:"1px solid #e0e0e0",borderRadius:0,padding:"0 12px",height:34,minHeight:34,fontSize:10,flexShrink:0,letterSpacing:1.5,cursor:"pointer",fontFamily:"'Barlow Condensed',sans-serif",fontWeight:800,whiteSpace:"nowrap",display:"flex",alignItems:"center",justifyContent:"center"},
  ...
  fastBadge:{position:"absolute",bottom:10,left:10,background:"#007AFF",color:"#fff",padding:"3px 10px",fontSize:10,fontWeight:800,letterSpacing:1.5,fontFamily:"'Barlow Condensed',sans-serif",zIndex:3},
