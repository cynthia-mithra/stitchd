...
export const S={
  ...
  marqueeInner:{display:"inline-block",whiteSpace:"nowrap",fontFamily:"'Barlow Condensed',sans-serif",fontSize:11,fontWeight:700,letterSpacing:2,color:"#6f6f6f",animation:"marquee 30s linear infinite"},
  ...
  cardPrevPrice:{fontFamily:"'Barlow Condensed',sans-serif",fontSize:14,fontWeight:700,color:"#6b6b6b",textDecoration:"line-through",letterSpacing:-0.3},
  ...
  cardBody:{padding:"12px 14px",display:"flex",flexDirection:"column",flex:1},
  cardCatLabel:{fontSize:10,fontFamily:"'Barlow Condensed',sans-serif",fontWeight:800,letterSpacing:2,marginBottom:4},
  cardName:{fontFamily:"'Barlow Condensed',sans-serif",fontSize:19,fontWeight:800,color:"#111",marginBottom:8,lineHeight:1.1,letterSpacing:0.3,whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"},
  ...
  cardFoot:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8,marginTop:"auto"},
  cardPrice:{fontFamily:"'Barlow Condensed',sans-serif",fontSize:26,fontWeight:900,letterSpacing:-0.5},
  cardSizePill:{fontFamily:"'Barlow Condensed',sans-serif",fontSize:11,fontWeight:700,letterSpacing:0.5,color:"#777",border:"1.5px solid #e3e3e3",padding:"3px 9px",whiteSpace:"nowrap"},
  ...
  emptySub:{fontFamily:"'Barlow',sans-serif",fontSize:15,color:"#6b6b6b",lineHeight:1.55,maxWidth:380,margin:"0 0 24px"},
  main:{maxWidth:1200,margin:"0 auto",padding:"20px 12px"},
  back:{background:"none",border:"none",color:"#6b6b6b",fontSize:12,cursor:"pointer",marginBottom:32,padding:0,fontWeight:800,letterSpacing:2,fontFamily:"'Barlow Condensed',sans-serif",textTransform:"uppercase"},
  ...
  measLbl:{fontSize:9,color:"#6b6b6b",letterSpacing:2,fontWeight:800,fontFamily:"'Barlow Condensed',sans-serif",marginTop:2},
  ...
  aN:{background:"#f5f5f5",color:"#808080",borderColor:"#eee"},
  ...
  profileMeta:{fontFamily:"'Barlow Condensed',sans-serif",fontSize:12,fontWeight:700,letterSpacing:2,color:"#6f6f6f"},
  ...
  uploadText:{fontFamily:"'Barlow Condensed',sans-serif",fontSize:10,fontWeight:800,letterSpacing:1.5,color:"#6f6f6f"},
  ...
  googleBtn:{display:"flex",alignItems:"center",justifyContent:"center",gap:12,border:"2px solid #111",padding:"14px",fontFamily:"'Barlow Condensed',sans-serif",fontWeight:800,fontSize:13,letterSpacing:2,color:"#111",textDecoration:"none",marginBottom:12,cursor:"pointer"},
  appleBtn:{display:"flex",alignItems:"center",justifyContent:"center",gap:10,background:"#111",border:"2px solid #111",padding:"14px",fontFamily:"'Barlow Condensed',sans-serif",fontWeight:800,fontSize:13,letterSpacing:2,color:"#fff",textDecoration:"none",marginBottom:20,cursor:"pointer"},
  ...
  bagItemSeller:{fontFamily:"'Barlow Condensed',sans-serif",fontSize:11,fontWeight:700,letterSpacing:1.5,color:"#6f6f6f",marginTop:2,textTransform:"uppercase"},
